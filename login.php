...
<section class="navbar">
  ...
  <span class="navbar-header"><a ><img src="images/1.png" alt="Tn-WaterMarkingDemo" width="165" height="56" 						/></a></span><span class="navbar-header"></div>
	        		...
	        		<div id="loginform" class="form-horizontal" rule="form">
	          			...
	          			<div style="margin-top: 10px" class="form-group">
	            			<div class="center col-md-12 col-xs-12 controls">
	              				<button id="login-btn" class="btn btn-success"><i class="fa fa-sign-in"></i> Đăng nhập ngay</button>
	            			</div>
	          			</div>
	          			<div class="form-group">
	            			<div class="col-md-12 col-xs-12 control">
	              				<div style="border-top: 1px solid #888; padding-top: 15px; font-size: 85%" ><a href="#signupbox" onClick="$('#loginbox').hide(); $('#signupbox').show()">Đăng kí tài khoản</a>
	              				</div>
		            		</div>
		          		</div>
		        	</div>
	        		...
	        		<div id="signupform" class="form-horizontal" role="form">
						...
						<div class="form-group">
						  	<div class="center col-md-12 col-xs-12 control">
						      	<button id="signup-btn" type="button" class="btn btn-danger"><i class="glyphicon glyphicon-send"></i> Đăng kí ngay</button>
		              		</div>
		          		</div>
						<div class="form-group">
							<div class="col-md-12 col-xs-12 control">
